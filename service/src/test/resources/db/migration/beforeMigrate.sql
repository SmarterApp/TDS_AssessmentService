/***********************************************************************************************************************
  ...
  Since the legacy system stores related data in two separate schemas we need to modify both config and itembank

***********************************************************************************************************************/

ALTER DATABASE itembank CHARACTER SET utf8 COLLATE utf8_unicode_ci;
