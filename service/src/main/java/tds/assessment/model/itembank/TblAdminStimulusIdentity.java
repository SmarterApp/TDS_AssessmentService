...
@Embeddable
public class TblAdminStimulusIdentity implements Serializable {
    @NotNull
     ...
     */
    private TblAdminStimulusIdentity() {
    }

    TblAdminStimulusIdentity(final String stimulusKey, final String segmentKey) {
    ...
    public boolean equals(final Object o) {
        ...
        final TblAdminStimulusIdentity that = (TblAdminStimulusIdentity) o;
