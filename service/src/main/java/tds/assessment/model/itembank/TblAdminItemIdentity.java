...
@Embeddable
public class TblAdminItemIdentity implements Serializable{
    @NotNull
     ...
     */
    private TblAdminItemIdentity() {
    }

    TblAdminItemIdentity(final String itemId, final String segmentKey) {
        this.itemId = itemId;
    ...
    public boolean equals(final Object o) {
        ...
        final TblAdminItemIdentity that = (TblAdminItemIdentity) o;
