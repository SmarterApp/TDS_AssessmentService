...
public interface TestToolDefaultsHelper {
    Map<String, TestToolDefaults> TOOL_DEFAULTS_MAP = new ImmutableMap.Builder<String, TestToolDefaults>()
        .put("American Sign Language",
            new TestToolDefaults.Builder("American Sign Language")
                .withArtFieldName("TDS_Acc-ASL")
